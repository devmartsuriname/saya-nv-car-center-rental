...
import { driversData } from '../../data/team/teamData';
                                    ...
                                    <div className="team-three__img-box">
                                        <div className="team-three__img">
                                            ...
                                            <div className="team-three__social">
                                                <Link to="/inner/driver-details"><i className="icon-facebook"></i></Link>
                                                <Link to="/inner/driver-details"><i className="icon-twitter"></i></Link>
                                                <Link to="/inner/driver-details"><i className="icon-linkedin"></i></Link>
                                                <Link to="/inner/driver-details"><i className="icon-instagram-1"></i></Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="team-three__content">
                                        <h3 className="team-three__name">
                                            <Link to="/inner/driver-details">{member.name}</Link>
                                        </h3>
