                            ...
                            <div className="blog-details__content">
                                <div className="blog-details__user-and-meta">
                                    ...
                                    <ul className="blog-details__meta list-unstyled">
                                        <li><a href="#"><span className="icon-comments"></span>Comments (05)</a></li>
                                        <li><a href="#"><span className="icon-clock"></span>4 Min Read</a></li>
                                    </ul>
                                </div>
                                <h3 className="blog-details__title">Where Early Adopters And Innovation Seekers Find Lively Imaginative Tech.</h3>
                                ...
                                <p className="blog-details__text-2">The wise man therefore always holds in these matters to this principle of selection. He rejects pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains to the selection point.</p>
                                ...
                                <h3 className="blog-details__title-2">Rental cost of sport and other cars</h3>
                                <p className="blog-details__text-3">Out enigma ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute inure dolor in the reprehenderit in voluptate velit esse cillum dolore eu fugiat null pariatur. Excepteur snit occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                <div className="blog-details__img-box">
                                    <div className="row">
                                        <div className="col-xl-6">
                                            <div className="blog-details__img-box-img">
                                                <img src={blogBoxImg1} alt="Image" />
                                            </div>
                                        </div>
                                        <div className="col-xl-6">
                                            <div className="blog-details__img-box-img">
                                                <img src={blogBoxImg2} alt="Image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="comment-one">
                                    <div className="comment-one__single">
                                        ...
                                        <div className="comment-one__content">
                                            ...
                                            <p>The wise man therefore always holds in these matters to this principle of selection. He rejects pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains to the selection point. But in certain to all this circumstances</p>
                                            <div className="comment-one__btn-box">
                                                <a href="#" className="comment-one__btn"><span className="icon-share-alt"></span>Reply</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="comment-one__single">
                                ...
                                <div className="comment-form">
                                    ...
                                    <p className="comment-form__text">By using form u agree with the message sorage, you can contact us directly now</p>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-12">
                                                ...
                                                <div className="comment-form__btn-box">
                                                    <button type="submit" className="thm-btn comment-form__btn">submit now <span className="fas fa-arrow-right"></span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
