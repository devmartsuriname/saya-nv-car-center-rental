...
import { listingThreeData } from '../../data/listing/ListingData';
import type { ListingThreeItem } from '../../data/listing/listType';
                                        ...
                                        <div className="listing-three__single">
                                            ...
                                            <div className="listing-three__content">
                                                ...
                                                <div className="listing-three__car-rent-and-btn-box">
                                                    <p className="listing-three__car-rent"><span>${item.price}/</span> Day</p>
                                                    <div className="listing-three__btn-box">
                                                        <Link to="/inner/listing-single" className="listing-three__btn">
